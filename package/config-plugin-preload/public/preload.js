...
var compose = __webpack_require__(4296);
...
var _require = __webpack_require__(8491),
  noop = _require.noop;
function getAsByUri(uri) {
  var pairs = uri.split('.');
  var extname = pairs.pop();
  var ext = '.' + extname;
  switch (true) {
...
exports.importLink = function importLink(uri, options) {
  ...
  var failureCallback = options.failureCallback || noop;
  var completeCallback = options.completeCallback || noop;
  var as = getAsByUri(uri);
