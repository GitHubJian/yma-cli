...
type WebpackStats = webpack.StatsOptions;
...
interface ExternalsFunctionCallback {
    ...
    (
        error: null,
        result: string | string[] | ExternalsObjectElement,
        type?: string
    ): void;
}
...
declare class Config extends __Config.ChainedMap<void> {
    ...
    externals(value: WebpackExternalsElement | WebpackExternalsElement[]): this;
    ...
    stats(value: WebpackStats): this;
    target(value: string): this;
    watch(value: boolean): this;
    watchOptions(value: WebpackWatchOptions): this;
...
declare namespace Config {
    ...
    class Plugins<
        Parent,
        PluginType extends WebpackPlugin
    > extends TypedChainedMap<Parent, Plugin<Parent, PluginType>> {}

    class Plugin<Parent, PluginType extends WebpackPlugin>
        extends ChainedMap<Parent>
        implements Orderable
    {
        init<P extends PluginType | PluginClass>(
            value: (
                plugin: P,
                args: P extends PluginClass ? ConstructorParameters<P> : any[]
            ) => PluginType
        ): this;
        use<P extends string | PluginType | PluginClass>(
            plugin: P,
            args?: P extends PluginClass ? ConstructorParameters<P> : any[]
        ): this;
        tap<P extends PluginClass>(
    ...
    class DevServer extends ChainedMap<Config> {
        ...
        stats(value: webpack.StatsOptions): this;
    ...
    class Optimization extends ChainedMap<Config> {
        ...
        runtimeChunk(
            value: boolean | 'single' | 'multiple' | RuntimeChunk
        ): this;
