...
const parserOptions = base.parserOptions;
...
function getVersionRange() {
    try {
        ...
        return dependencies.vue || peerDependencies.vue || devDependencies.vue || null;
    } catch (_) {
        // nothing can be done
    }
 ...
 */
export function getRules(strict, base = {}, version = getVersion(2)) {
 ...
 */
export function getConfig(strict, base = {}, version = getVersion(2)) {
    return {
